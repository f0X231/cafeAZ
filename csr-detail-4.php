        ...
        <div class="amazon-csr-detail fonts_cordiaupc fonts_size_txt_text">
            <div class="row">
                ...
                <div class="columns small-12 medium-12 large-10 large-offset-1">
                    <h2 class="fonts_dbadmanx fonts_size_txt_title no-margin-bottom">ซื้อเมล็ดกาแฟดิบ</h2>
                    <div class="news-datetime-slide margin-bottom25">1 มกราคม 2560</div>

                    <div>
                        <p class="weight_bold no-margin-bottom">ซื้อเมล็ดกาแฟดิบ จากบริษัท ประชารัฐรักษามัคคีน่าน (วิสาหกิจเพื่อชุมชน) จำกัด ภายในปี พ.ศ. 2559</p>
                    </div>
                </div>
