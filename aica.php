...
<html class="no-js" lang="en" dir="ltr">
    ...
    <body>
        ...
        <!-- AICA -->
        <div class="news-detail fonts_cordiaupc fonts_size_txt_text margin-top50">
            <div class="row">
                <div class="columns small-12 medium-12 large-12">
                    <h2 class="text-center fonts_dbadmanx fonts_size_txt_title">ศูนย์ธุรกิจคาเฟ่ อเมซอน<br />Amazon Inspiring Campus (AICA)</h2>

                    <div class="news-detail-txt text-left">ศูนย์ธุรกิจคาเฟ่ อเมซอน  Amazon Inspiring Campus หรือ AICA คือ แหล่งถ่ายทอดแรงบันดาลใจในการสร้างสรรค์กาแฟ  แหล่งรวบรวมความภูมิใจของ “คาเฟ่ อเมซอน” ที่จะถ่ายทอดแรงบันดาลใจของเรา ให้แก่ผู้ที่หลงใหลในกลิ่นและรสชาติของกาแฟ AICA แบ่งออกเป็น 3 ส่วนได้แก่
                        <ul class="ul_middle_dot margin-left50">
            ...
            <div class="row">
                <div class="columns small-12 medium-12 large-12">
                    <div class="news-detail-txt">
                        ...
                        <ul class="aica-exhibition">
                          <li>Amazon Treasure เป็นโซนที่ ให้ข้อมูลต่างๆ เกี่ยวกับกาแฟ ทั้งด้านแหล่งเพาะปลูก วัฒนธรรมกาแฟของชนชาติต่างๆ และแสดงถึงเรื่องราวความเป็นมาของแบรนด์ คาเฟ่ อเมซอน รวมไปถึงรางวัลแห่งความภูมิใจของเรา</li>
                          <li>Discovery Land คือโซนที่เปรียบเสมือน Green Oasis ที่สร้างความสุข ความสดชื่นให้แก่ผู้เข้าชม ท่ามกลางธรรมชาติเหล่านี้ผู้เข้าชมยังสามารถสัมผัสประสบการณ์ความสนุก พร้อมทั้งค้นพบเกร็ดความรู้ที่น่าสนใจเกี่ยวกับกาแฟไปควบคู่กัน</li>
                          <li>Coffee Woodhouse หรือศาลาเมล็ดกาแฟ เป็นโซนที่ใช้เป็นมุมสําหรับพักผ่อนหรือทํากิจกรรมต่างๆร่วมกัน โดยศาลานี้ได้รับแรงบันดาลใจในการออกแบบจากเมล็ดกาแฟอีกด้วย</li>
                          <li>Coffee Trail คือเส้นทางเดินที่แสดงให้เห็นถึงการคัดสรรเมล็ดกาแฟจากแหล่งที่ปลูกผ่านกรรมวิธีต่างๆจนได้เมล็ดกาแฟคุณภาพดีส่งถึงโรงคั่วของเรา</li>
                          <li>Amazon Creation คือโซนที่เราจะให้เห็นขั้นตอนการผลิตกาแฟคั่วที่พิถีพิถันตามแบบฉบับของคาเฟ่ อเมซอน</li>
                          <li>Coffeeology คือโซนของศาสตร์แห่งการคั่วบดและการชงกาแฟ เพื่อให้ได้กลิ่นและรสชาติของกาแฟได้ครบถ้วนอย่างสมบูรณ์ นอกจากนั้นในโซนนี้ยังมีต้นกาแฟให้ผู้เข้าชมได้เห็นและเรียนรู้ด้วยเช่นกัน</li>
                          <li>Amazon Journey Theater คือ โซนสุดท้ายของนิทรรศการการเรียนรู้ โซนนี้คือห้องภาพยนตร์ 3 มิติที่จะพาทุกคนไปสัมผัสกับ Taste of Amazon โดยที่เราจะให้ผู้เข้าชมเห็นเบื้องหลังกาแฟแต่ละแก้วของ Café Amazon</li>
                        </ul>
