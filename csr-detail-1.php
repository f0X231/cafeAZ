        ...
        <div class="amazon-csr-detail fonts_dbadmanx fonts_size_txt_text">
            <div class="row">
                ...
                <div class="columns small-12 medium-12 large-10 large-offset-1">
                    ...
                    <div>
                        <p class="weight_bold no-margin-bottom">Amazon Bio Cup (แก้วกระดาษเคลือบพลาสติกชีวภาพชนิด PBS)</p>
                        <ul class="amazon-csr-indent">
                            <li>คาเฟ่อเมซอนได้เริ่มนำบรรจุภัณฑ์  Amazon  Bio Cup   ซึ่งเป็นแก้วกระดาษเคลือบด้วยพลาสติกชีวภาพชนิด  PBS  ย่อยสลายได้ 100%  หนึ่งในนวัตกรรมรักษ์โลกจากกลุ่ม ปตท.  มานำร่องใช้กับเครื่องดื่มร้อนเฉพาะกลุ่มเมนูกาแฟพรีเมี่ยม   ในร้านคาเฟ่อเมซอนที่ตั้งภายนอกสถานีบริการน้ำมันเมื่อเดือนเมษายน 2555 ที่ผ่านมา</li>
                            ...
                            <li>การใช้  Amazon Bio Cup ทดแทนแก้วพลาสติก (แก้วกาแฟร้อน) ในทุกสาขา เป็นเสมือนก้าวแรกที่คาเฟ่อเมซอนได้แสดงเจตจำนงชัดเจนในการดำเนินธุรกิจอย่างใส่ใจต่อสิ่งแวดล้อม โดยการใช้ Amazon Bio Cup จะสามารถช่วยลดขยะพลาสติกได้กว่า 200 ตันต่อปี</li>
                            <li>แผนการขยายสาขาของร้าน Café Amazon มีอย่างต่อเนื่องทั้งในและนอกสถานีบริการ โดยในสิ้นปี 2559 Café Amazon มีสาขามากถึง 1,700 สาขา และมียอดขายสูงถึง 140 ล้านแก้ว/ปี</li>
                        </ul>
                        <p class="weight_bold no-margin-bottom">Amazon Bio Cup PLA</p>
                        <ul class="amazon-csr-indent">
                            <li>มีนาคม 2558 Café Amazon นำร่องใช้แก้ว Ingeo PLA (พลาสติกย่อยสลายได้ ผลิตจากพืช 100%) ทดแทนแก้วพลาสติกสำหรับเครื่องดื่มเย็นขนาด 12, 16, และ 22 ออนซ์ ใน 5 สาขา(บริเวณอาคาร ปตท. สำนักงานใหญ่ และอาคาร EnCo)</li>
                            <li>โดยคาดว่าจะมีปริมาณการใช้ประมาณ 450,000 ใบต่อปีี</li>
                        </ul>
                    </div>
                </div>
